...
class SpinLock {
  var l: atomic bool;
  //var log = new shared Logging.YggdrasilLogging();
  var log: shared Logging.Logger();
  var n: atomic int;
  var t: string;
  ...
  inline proc lock(hstring: Logging.logHeader) throws {
    if lockLog {
  ...
  inline proc unlock(hstring: Logging.logHeader) throws {
    this.n.sub(1);
    if this.n.read() != 0 {
  ...
  inline proc rl(hstring: Logging.logHeader) {
  ...
  inline proc url(hstring: Logging.logHeader) {
    if lockLog {
  ...
  inline proc wl(hstring: Logging.logHeader) {
  ...
  inline proc uwl(hstring: Logging.logHeader) {
